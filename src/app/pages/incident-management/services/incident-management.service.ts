...
// Real API integration for Incident Management's dashboard (NSTT list) +
// column preferences. Endpoint/header/response contract source:
// djp/incidentmanagement/src/app/modules/dashboardModule/services/dashboard.service.ts
// and .../components/im-dashboard-ui/im-dashboard-ui.component.ts.
//
// Unlike EscalationMatrixService, DashboardService in DJP correctly binds
// its own apiEndPoint field straight to environment.apiEndPoint (verified
// via grep) — no base-URL bug to route around here.
@Injectable({
  providedIn: 'root'
})
